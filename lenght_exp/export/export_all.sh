...
adapter_name_or_path: saves/Qwen2.5-Math-1.5B-limo-__STEP__/lora/sft
trust_remote_code: true

### export
export_dir: lenght_exp/eva_model/Qwen2.5-Math-1.5B-limo-__STEP__
export_size: 5
export_device: cpu
...
for ((step=2000; step<=20000; step+=1000)); do
    config_file="lenght_exp/export/export_qwen_limo_${step}.yaml"
