...
BASE_CONFIG="lenght_exp/fsdp_qlora/qwen_math_lora_sft.yaml"

# accelerate 相关配置
ACCELERATE_CONFIG="lenght_exp/accelerate/fsdp_config.yaml"
PORT=6570
...
for (( i=$START; i<=$END; i+=$STEP )); do
    ...
    new_dataset="limo_${i}"
    new_output_dir="saves/Qwen2.5-Math-1.5B-limo-${i}/lora/sft"
    
    # 生成临时配置文件
    # tmp_config="temp_config_${i}.yaml"
    tmp_config="lenght_exp/temp_configs/temp_config_${i}.yaml"
